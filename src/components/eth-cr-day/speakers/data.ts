...
export const SpeakersData: Array<SpeakerType> = [
  {
    name: "Perchy",
    image: "perchy.jpg",
  ...
  },
  {
    name: "Karla Cordoba",
    image: "karla.jpg",
    title: "Founder ReFi Costa Rica",
    description:
      "Blockchain, Impact & ReFi - Cambiatus Co Founder - Founder ReFi Costa Rica ",
    topic: "Intro a Governanza, DAOs, CofiBlocks",
  },
  {
    name: "Robert Ramirez",
    image: "robert.jpg",
