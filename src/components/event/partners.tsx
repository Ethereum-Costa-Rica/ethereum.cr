import { Box, Heading, Image, Link, useMediaQuery, Text, useTheme } from "@chakra-ui/react";
...
const Partners = ({ context = 'event' }: PartnersProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <Trans
          i18nKey={context === 'event' ? "ethPuraVida.partners.title" : "homeContent.partners.title"}
          components={{
